import { STATE, setTraceRoot, selectPath, gotoTraceHistory, clearTraceHistory, getTraceRoot, toggleTraceSource, toggleTraceBranch } from '../state.js';
...
function body(tree, onChange) {
  ...
  wrap.appendChild(detailPane(tree, tree, onChange));
  return wrap;
}
